...
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/dune/persistent/users/arafique/2x2/simdumpnew2.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("/pnfs/dune/persistent/users/arafique/2x2/simdumpnew2.root");

//      }
//      TDirectory * dir = (TDirectory*)f->Get("/pnfs/dune/persistent/users/arafique/2x2/simdumpnew2.root:/simdumpnew");
//      dir->GetObject("ndsim",tree);
