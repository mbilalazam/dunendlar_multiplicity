...
int main() {
    ...
    findLeavesAndBranches("/dune/app/users/mazam/working_area/dunendlar_multiplicity/bilal_work/inProgress/MiniRun3.1_FHC/MicroRun3.1_1E18_FHC.flow.00000.FLOWTestunmergedhits.root");
    return 0;
}
